#' ---
#' title: "OIStats-v3: Lab 1: Introduction to data"
#' output: pdf_document
#' ---
# 
# 
# You may want to turn on "Soft-wrap R Source Files" in Tools/Global Options/Code
# 
...
# 
#    BMI =weight (lb)height(in)2703 
# 
# 703 is the approximate conversion factor to change units from metric (meters and kilograms) to imperial (inches and pounds). The following two lines first make a new object called bmi and then creates box plots of these values,
...
# (http://creativecommons.org/licenses/by-sa/3.0). This lab was adapted for OpenIntro by Andrew Bray and Mine Çetinkaya-Rundel from a lab written by Mark Hansen of UCLA Statistics.
