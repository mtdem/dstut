...
studysites_raw <- st_read("../../../../data/sf-shp/bearpyrenees.shp")
...
#' 
## ----message=FALSE, warning=FALSE, paged.print=FALSE----------------------------------------------------------------
clc2012 <- st_read("../../../../data/sf-shp/CLC12_FR_RGF.shp")
...
#' 
## ----message=FALSE, warning=FALSE, paged.print=FALSE----------------------------------------------------------------
load("../../../../data/sf-shp/france_population_data_2016.RData")
glimpse(df.france)
...
#' # Read in data
## ----message=FALSE, warning=FALSE, paged.print=FALSE----------------------------------------------------------------
roads <- st_read("../../../../data/sf-shp/TRONCON_ROUTE.shp")
