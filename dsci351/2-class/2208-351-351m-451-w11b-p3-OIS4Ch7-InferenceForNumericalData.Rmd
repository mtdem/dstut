---
title: "OIS4 Chap 7, Inference for numerical data"
subtitle: "2208-351-351m-451-w11b-p3-OIS4Ch7-InferenceForNumericalData"
output:
  html_document:
    css: ../lab.css
    highlight: pygments
...
knitr::opts_chunk$set(eval = TRUE, results = TRUE, message = TRUE)
```
...
```{ inf-weight-habit-ht-initial, tidy=FALSE, warning = FALSE}
obs_diff <- yrbss %>%
...
1. How many of these `null` permutations 
...
1.  Construct and record a confidence interval 
...
1.  Calculate a new confidence interval 
