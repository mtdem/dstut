---
title: "Geographic Information Systems and mapping in R"
subtitle: "Introduction to the sf package, for DSCI351/353 class"
...
# Class Readings, Assignments, Syllabus Topics
  ...
  - Readings: 
    - For today: OIS9
    - For next class: ISLR 3.1
  - Laboratory Exercises: 
    - LE 6: Due Tuesday November 22nd  
    - LE 7: Given out Wednesday November 23rd
  ...
  - Semester Projects
    ...
    - All DSCI 351/351M/451 Students: 
      - **Peer Grading of Report Out #3 is Due Tuesday November 29th**
    - Exams
...
---
## Olivier Gimenez, and the description file of the sf package

Olivier Gimenez is a scientist 

  * at the [French National Centre for Scientific Research (CNRS)](https://www.cnrs.fr/en/cnrs)

Support for simple features, 

* a standardized way to encode spatial vector data. 

* Binds to 'GDAL' for reading and writing data, 

* to 'GEOS' for geometrical operations, and 

* to 'PROJ' for projection conversions and datum transformations. 

* Optionally uses the 's2' package for spherical geometry operations on geographic coordinates.

Author: Edzer Pebesma, Roger Bivand, Etienne Racine, Michael Sumner,
  Ian Cook, Tim Keitt, Robin Lovelace, Hadley Wickham, Jeroen Ooms, 
  Kirill Müller, Thomas Lin Pedersen, Dan Baston 
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, out.width = "700px", fig.align = "center"}
...
st_crs(forest) = st_crs(forest)  # Need to update to the new coord. system
...
studysites <- studysites %>% 
  st_transform(crs = sf::st_crs(forest))  #<<
glimpse(studysites)
```
...
```{r message = FALSE, warning = FALSE, paged.print = FALSE, fig.align = 'center', fig.dim = c(15, 7), dpi = 150}
studysites %>%
  ggplot() + 
  geom_sf() +
...
| Website: [**https://oliviergimenez.github.io/**](https://oliviergimenez.github.io/) |
| Twitter: [**@oaggimenez**](https://twitter.com/oaggimenez)                         |
| Github [**@oliviergimenez**](https://github.com/oliviergimenez)
