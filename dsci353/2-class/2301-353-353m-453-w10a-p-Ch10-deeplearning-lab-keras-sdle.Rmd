...
We use the `keras` package, which interfaces to the

  - `tensorflow` package 
  - which in turn links to efficient `python` code. 
  
This code is impressively fast, and the package is well-structured. 

A good companion is the text **Deep Learning with R 2nd Ed.**
(F. Chollet and
