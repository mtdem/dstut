#' ---
#' title: "OIStats-v3: Introduction to R and RStudio"
#' output: pdf_document
#' ---
...
# R documents all of its functions extensively. To read what a function does and learn the arguments that are available to you, just type in a question mark followed by the name of the function that you’re interested in. Try the following.
